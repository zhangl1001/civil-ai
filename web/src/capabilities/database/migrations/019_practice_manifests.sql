ALTER TABLE learning_assets RENAME TO learning_assets_v18;
...
CREATE TABLE learning_assets (
  ...
  kind TEXT NOT NULL CHECK(kind IN (
    ...
    'digest_monthly','study_lecture','mock_manifest','practice_manifest',
    'practice_session_draft','chat_attachment','profile_insight'
  )),
...
SELECT
  id,exam_cycle_id,kind,business_key,title,status,payload_json,source_agent_run_id,
  version,created_at,updated_at
FROM learning_assets_v18;

DROP TABLE learning_assets_v18;
