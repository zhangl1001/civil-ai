<template>
  <div :class="['tutor-wrongbook', 'app-page', { 'review-action-visible': showReviewAction }]">
    ...
    <StickyActionBar v-if="showReviewAction" avoid-bottom-nav>
      <button class="start-review-button primary" type="button" :disabled="startingReview || !selectedReviewEntries.length" @click="startReview">
        <RotateCcwIcon />
...
const showReviewAction = computed(() => loaded.value
  && !error.value
  && mode.value === 'review'
