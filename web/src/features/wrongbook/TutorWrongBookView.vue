<template>
  <div class="tutor-wrongbook app-page">
    ...
    <PullToRefresh :class="['wrongbook-scroll', { 'with-floating-action': showReviewAction }]" :on-refresh="load">
