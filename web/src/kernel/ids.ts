...
export type QuestionSourceId = Brand<string, 'QuestionSourceId'>;
export type QuestionSourceLinkId = Brand<string, 'QuestionSourceLinkId'>;
export type QuestionLineageId = Brand<string, 'QuestionLineageId'>;
export type QuestionSourceImportReceiptId = Brand<string, 'QuestionSourceImportReceiptId'>;
export type QuestionReferencePackId = Brand<string, 'QuestionReferencePackId'>;
export type QuestionImportDraftId = Brand<string, 'QuestionImportDraftId'>;
export type QuestionImportCandidateId = Brand<string, 'QuestionImportCandidateId'>;
export type QuestionImportPublishReceiptId = Brand<string, 'QuestionImportPublishReceiptId'>;
...
export type TutorCycleConclusionId = Brand<string, 'TutorCycleConclusionId'>;
export type AbilityCalibrationSnapshotId = Brand<string, 'AbilityCalibrationSnapshotId'>;
