import type { AgentRunId, AssessmentRole, CapabilityNodeId, JsonObject } from '@/kernel/public';
...
export class RequestStructuredPractice {
  ...
  async execute(command:{idempotencyKey:string;sourceAgentRunId?:AgentRunId;requestedCount:number;difficultyMin:number;difficultyMax:number;assessmentRole?:AssessmentRole;constraints?:JsonObject;goal?:string;capabilityNodeId?:CapabilityNodeId;capabilityCode?:string}) : Promise<GenerationAggregate>{
